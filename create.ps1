...
Write-Host "Creating WellHive directory..."
New-Item -ItemType Directory -Name "WellHive" -Force | Out-Null
Set-Location -Path "WellHive"

Write-Host "Creating Solution and Projects..."
dotnet new sln -n WellHive
dotnet new webapi -n WellHive.Api -o src/WellHive.Api --use-controllers
dotnet new classlib -n WellHive.Core -o src/WellHive.Core
dotnet new classlib -n WellHive.Infrastructure -o src/WellHive.Infrastructure
dotnet new classlib -n WellHive.Providers -o src/WellHive.Providers
dotnet new xunit -n WellHive.Tests -o tests/WellHive.Tests

Write-Host "Adding Projects to Solution..."
dotnet sln add src/WellHive.Api/WellHive.Api.csproj
dotnet sln add src/WellHive.Core/WellHive.Core.csproj
dotnet sln add src/WellHive.Infrastructure/WellHive.Infrastructure.csproj
dotnet sln add src/WellHive.Providers/WellHive.Providers.csproj
dotnet sln add tests/WellHive.Tests/WellHive.Tests.csproj

Write-Host "Linking Project Dependencies..."
dotnet add src/WellHive.Api/WellHive.Api.csproj reference src/WellHive.Core/WellHive.Core.csproj src/WellHive.Infrastructure/WellHive.Infrastructure.csproj src/WellHive.Providers/WellHive.Providers.csproj
dotnet add src/WellHive.Infrastructure/WellHive.Infrastructure.csproj reference src/WellHive.Core/WellHive.Core.csproj
dotnet add src/WellHive.Providers/WellHive.Providers.csproj reference src/WellHive.Core/WellHive.Core.csproj src/WellHive.Infrastructure/WellHive.Infrastructure.csproj
dotnet add tests/WellHive.Tests/WellHive.Tests.csproj reference src/WellHive.Api/WellHive.Api.csproj src/WellHive.Core/WellHive.Core.csproj src/WellHive.Infrastructure/WellHive.Infrastructure.csproj src/WellHive.Providers/WellHive.Providers.csproj

Write-Host "Installing NuGet Packages..."
dotnet add src/WellHive.Infrastructure/WellHive.Infrastructure.csproj package Microsoft.Extensions.Configuration.Abstractions
dotnet add src/WellHive.Providers/WellHive.Providers.csproj package Bogus
dotnet add src/WellHive.Providers/WellHive.Providers.csproj package Npgsql.EntityFrameworkCore.PostgreSQL
dotnet add src/WellHive.Providers/WellHive.Providers.csproj package Microsoft.Extensions.Diagnostics.HealthChecks.EntityFrameworkCore
dotnet add tests/WellHive.Tests/WellHive.Tests.csproj package Moq
dotnet add tests/WellHive.Tests/WellHive.Tests.csproj package FluentAssertions
dotnet add tests/WellHive.Tests/WellHive.Tests.csproj package Microsoft.AspNetCore.Mvc.Testing

Write-Host "Creating Directories..."
$directories = @(
    "src/WellHive.Core/Interfaces",
    "src/WellHive.Core/Models",
    "src/WellHive.Infrastructure/Middleware",
    "src/WellHive.Infrastructure/Services",
    "src/WellHive.Api/Controllers",
    "deploy/base",
    "deploy/overlays/dev"
)
...
Remove-Item src/WellHive.Core/Class1.cs -ErrorAction SilentlyContinue
Remove-Item src/WellHive.Infrastructure/Class1.cs -ErrorAction SilentlyContinue
Remove-Item src/WellHive.Providers/Class1.cs -ErrorAction SilentlyContinue
Remove-Item src/WellHive.Api/Controllers/WeatherForecastController.cs -ErrorAction SilentlyContinue
Remove-Item src/WellHive.Api/WeatherForecast.cs -ErrorAction SilentlyContinue
